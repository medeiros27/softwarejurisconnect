...
def create_placeholder_images():
    """
    Função para criar arquivos de imagem placeholder para o sistema
    """
    import os
    import shutil
    ...
    # Criar logo
    logo = Image.new('RGBA', (200, 60), color=(44, 62, 80, 255))
    d = ImageDraw.Draw(logo)
    d.text((20, 15), "JurisConnect", fill=(255, 255, 255, 255))
    logo.save(os.path.join(img_dir, 'logo.png'))
    
    # Criar slides para carousel
    for i in range(1, 4):
        slide = Image.new('RGB', (800, 400), color=(52, 152, 219))
        d = ImageDraw.Draw(slide)
        d.text((350, 180), f"Slide {i}", fill=(255, 255, 255))
        slide.save(os.path.join(img_dir, f'slide{i}.jpg'))
